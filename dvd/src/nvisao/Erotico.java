 ...
 * @author Eduardo
 */
public class Erotico extends javax.swing.JFrame {
    ...
    public Erotico() {
        initComponents();
         preencherTabela("select * from dvds where tipo='Erotico'");
    }
    ...
    private void initComponents() {
        ...
        jLabelImagem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/py.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Erotico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
