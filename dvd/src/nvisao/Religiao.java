 ...
 * @author Eduardo
 */
public class Religiao extends javax.swing.JFrame {
    ...
    public Religiao() {
        initComponents();
         preencherTabela("select * from dvds where tipo='Religioso'");
    }
    ...
    private void initComponents() {
        ...
        jLabelImagem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/biblia.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Religiao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
