 ...
 * @author Eduardo
 */
public class ArtesMarciais extends javax.swing.JFrame {
    ...
    public ArtesMarciais() {
        initComponents();
         preencherTabela("select * from dvds where tipo='Artes Marciais'");
    }
    ...
    private void initComponents() {
        ...
        jLabelImagem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/jet.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ArtesMarciais.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ArtesMarciais().setVisible(true);
            }
        });
    }
